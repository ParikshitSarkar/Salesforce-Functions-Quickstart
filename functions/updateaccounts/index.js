...
export default async function (event, context, logger) {
    logger.info(`Invoking Updateaccounts with payload ${JSON.stringify(event.data || {})}`);
    ...
    const results = await context.org.dataApi.update(account);
